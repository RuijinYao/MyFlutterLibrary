...
class MySingleChildScrollView extends StatelessWidget {
  /// Creates a box in which a single user.widget can be scrolled.
  const MySingleChildScrollView({
    ...
    this.dragStartBehavior = DragStartBehavior.start,
        ...
        assert(
            ...
            'Primary ScrollViews obtain their ScrollController via inheritance from a PrimaryScrollController user.widget. '
